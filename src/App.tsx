...
const App: React.FC = () => {
  const faqData: FaqData[] = [
    ...
    },
    {
      ...
      answer: {
        en: "If you have an Israeli phone number you will receive an sms on the 22nd of August to confirm RSVP. If you are abroad, we will contact you",
        es: "Si tienes un número de teléfono israelí, recibirás un mensaje de texto el 22 de Agosto para confirmar tu presencia. Si estás en el extranjero, nosotros te contactaremos",
        he: 'אם יש לך מספר טלפון ישראלי, תקבל הודעת טקסט ב-22 באוגוסט לאישור הנוכחות. אם אתה בחו"ל, אנחנו ניצור קשר עמך',
      },
    },
    {
      question: {
      ...
      extraInfoBankTransfers: {
        en: "Extra info for transfers from abroad:",
        es: "Información adicional para transferencias desde el extranjero:",
        he: ':מידע נוסף על העברות בנקאיות מחו"ל.',
      },
    },
  ];

  const targetDate = new Date(2024, 8, 12, 19, 0);
